...
const Contact = () => {
  return (
    <div name='contact' className=' pt-20 bg-[#0a192f] flex justify-center items-center p-4 '>
      <form method='POST' action="https://getform.io/f/20125c97-4aea-4330-9712-2c7e85826906"  className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8'>
          <p className='text-4xl font-bold inline border-b-4 border-pink-600 text-gray-300'>
            Contact
          </p>
          <p className='text-gray-300 py-4'>
            //Submit the form below or shoot me an email - ericdndjee38@gmail.com
          </p>
          </div>
